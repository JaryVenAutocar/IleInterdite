...
class VueGrille extends JPanel implements Observer {
    ...
    /** Constructeur. */
    public VueGrille(CModele modele, JLabel j, JLabel j2, JLabel j3, JLabel j4, JLabel j5) { //
    ...
    public void update() { 
    	...
    	if(modele.partiePerdue == false && modele.tour != 0) {
	    	...
	    	if(modele.j1.keyElementList.isEmpty()) {
	    		j3.setText( "<html> J1 ne possede pas de cles. <br> </html>");
	    	} else { 
	    		...
	    		j3.setText("J1 possede les cles suivantes: "+ nbKeyAir + " " + element.air +", " + nbKeyTerre + " " + element.terre +", " + nbKeyFeu + " " + element.feu +", " + nbKeyEau + " " + element.eau+ ".");
	    	
	    	}
	    	
	    	if(modele.j2.keyElementList.isEmpty()) {
	    		j4.setText( "<html> J2 ne possede pas de cles. <br> </html>");
	    	} else {
	    		...
	    		j4.setText("J2 possede les cles suivantes: " + nbKeyAir + " " + element.air +", " + nbKeyTerre + " " + element.terre +", " + nbKeyFeu + " " + element.feu +", " + nbKeyEau + " " + element.eau + ".");
	    	
	    	}
	    	
	    	if(modele.j3.keyElementList.isEmpty()) {
	    		j5.setText( "<html> J3 ne possede pas de cles. <br> </html>");
	    	} else {
	    		...
	    		j5.setText("J3 possede les cles suivantes: " + nbKeyAir + " " + element.air +", " + nbKeyTerre + " " + element.terre +", " + nbKeyFeu + " " + element.feu +", " + nbKeyEau + " " + element.eau + ".");

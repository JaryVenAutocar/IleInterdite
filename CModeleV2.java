...
class CModele extends Observable {
    ...
    * 
    ...
    /* Cette fonction est utilisée pour inonder 3 cases à la fin de tour de chaque joueur.
     * Une zone asséchée devient inondée.
     * Une zone de type eau, feu, air ou terre devient inondée.
     * Une zone inondée devient submergée.
     * Une zone submergée le reste.
     * */
    ...
    /* Cette fonction permet de déplacer un joeur d'une case a gauche*/
    public void gauche() {
    ...
    /* Cette fonction permet de déplacer un joeur d'une case a droite */
    public void droite() {
    	ancienneZone = Zones[j.getX()][j.getY()].z;
    	prochaineZone = Zones[j.getX() + 1][j.getY()].z;
    ...
    /* Cette fonction permet de déplacer un joeur d'une case en bas */
    public void bas() {
    	ancienneZone = Zones[j.getX()][j.getY()].z;
    ...
    /* Cette fonction permet de déplacer un joeur d'une case en haut */
    public void haut() {
    	ancienneZone = Zones[j.getX()][j.getY()].z;
    	prochaineZone = Zones[j.getX()][j.getY() - 1].z;
